...
let DiffEditorEditors = class DiffEditorEditors extends Disposable {
    ...
    constructor(originalEditorElement, modifiedEditorElement, _options, _argCodeEditorWidgetOptions, _createInnerEditor, _instantiationService, _keybindingService) {
        ...
        this.modifiedModel = observableCodeEditor(this.modified).model;
        this.modifiedSelections = observableFromEvent(this, this.modified.onDidChangeCursorSelection, () => { var _a; return (_a = this.modified.getSelections()) !== null && _a !== void 0 ? _a : []; });
        ...
        this.originalCursor = observableFromEvent(this, this.original.onDidChangeCursorPosition, () => { var _a; return (_a = this.original.getPosition()) !== null && _a !== void 0 ? _a : new Position(1, 1); });
