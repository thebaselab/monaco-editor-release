...
export class ObservableCodeEditor extends Disposable {
    ...
    */
    ...
    constructor(editor) {
        ...
        this._versionId = observableValueOpts({ owner: this, lazy: true }, (_b = (_a = this.editor.getModel()) === null || _a === void 0 ? void 0 : _a.getVersionId()) !== null && _b !== void 0 ? _b : null);
        this.versionId = this._versionId;
        this._selections = observableValueOpts({ owner: this, equalsFn: equalsIfDefined(itemsEquals(Selection.selectionsEqual)), lazy: true }, (_c = this.editor.getSelections()) !== null && _c !== void 0 ? _c : null);
        ...
        this.value = derivedWithSetter(this, reader => { var _a, _b; this.versionId.read(reader); return (_b = (_a = this.model.read(reader)) === null || _a === void 0 ? void 0 : _a.getValue()) !== null && _b !== void 0 ? _b : ''; }, (value, tx) => {
        ...
        this.valueIsEmpty = derived(this, reader => { var _a; this.versionId.read(reader); return ((_a = this.editor.getModel()) === null || _a === void 0 ? void 0 : _a.getValueLength()) === 0; });
        this.cursorSelection = derivedOpts({ owner: this, equalsFn: equalsIfDefined(Selection.selectionsEqual) }, reader => { var _a, _b; return (_b = (_a = this.selections.read(reader)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : null; });
        ...
        this._register(this.editor.onDidChangeModelContent(e => {
            ...
            this._beginUpdate();
            try {
                this._versionId.set((_b = (_a = this.editor.getModel()) === null || _a === void 0 ? void 0 : _a.getVersionId()) !== null && _b !== void 0 ? _b : null, this._currentTransaction, e);
                this._forceUpdate();
            }
            finally {
                this._endUpdate();
    ...
    _forceUpdate() {
        ...
        try {
            this._model.set(this.editor.getModel(), this._currentTransaction);
            this._versionId.set((_b = (_a = this.editor.getModel()) === null || _a === void 0 ? void 0 : _a.getVersionId()) !== null && _b !== void 0 ? _b : null, this._currentTransaction, undefined);
