...
export class PlaceholderTextContribution extends Disposable {
    constructor(_editor) {
        ...
        this._shouldViewBeAlive = isOrWasTrue(this, reader => { var _a; return ((_a = this._state.read(reader)) === null || _a === void 0 ? void 0 : _a.placeholder) !== undefined; });
        this._view = derivedWithStore((reader, store) => {
            ...
            store.add(autorun(reader => {
                ...
                const shouldBeVisibile = (data === null || data === void 0 ? void 0 : data.placeholder) !== undefined;
                element.root.style.display = shouldBeVisibile ? 'block' : 'none';
                element.root.innerText = (_a = data === null || data === void 0 ? void 0 : data.placeholder) !== null && _a !== void 0 ? _a : '';
            }));
            store.add(autorun(reader => {
...
PlaceholderTextContribution.ID = 'editor.contrib.placeholderText';
