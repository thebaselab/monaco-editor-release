...
let ContentHoverController = class ContentHoverController extends Disposable {
    ...
    _initializeHoverParticipants() {
        ...
        this._register(this._contentHoverWidget.onDidResize(() => {
            this._participants.forEach(participant => { var _a; return (_a = participant.handleResize) === null || _a === void 0 ? void 0 : _a.call(participant); });
        }));
        return participants;
    }
    _registerListeners() {
    ...
    async updateHoverVerbosityLevel(action, index, focus) {
        var _a;
        (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.updateHoverVerbosityLevel(action, index, focus);
    }
    doesHoverAtIndexSupportVerbosityAction(index, action) {
        var _a, _b;
        return (_b = (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.doesHoverAtIndexSupportVerbosityAction(index, action)) !== null && _b !== void 0 ? _b : false;
    }
    getAccessibleWidgetContent() {
        var _a;
        return (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.getAccessibleWidgetContent();
    }
    getAccessibleWidgetContentAtIndex(index) {
        var _a;
        return (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.getAccessibleWidgetContentAtIndex(index);
    }
    focusedHoverPartIndex() {
        var _a, _b;
        return (_b = (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.focusedHoverPartIndex) !== null && _b !== void 0 ? _b : -1;
    }
    containsNode(node) {
    ...
    get isColorPickerVisible() {
        var _a, _b;
        return (_b = (_a = this._renderedContentHover) === null || _a === void 0 ? void 0 : _a.isColorPickerVisible()) !== null && _b !== void 0 ? _b : false;
    }
