...
export class IncreaseHoverVerbosityLevel extends EditorAction {
    ...
    run(accessor, editor, args) {
        ...
        hoverController.updateHoverVerbosityLevel(HoverVerbosityAction.Increase, index, args === null || args === void 0 ? void 0 : args.focus);
    }
}
export class DecreaseHoverVerbosityLevel extends EditorAction {
    ...
    run(accessor, editor, args) {
        ...
        const index = (args === null || args === void 0 ? void 0 : args.index) !== undefined ? args.index : hoverController.focusedHoverPartIndex();
        (_a = HoverController.get(editor)) === null || _a === void 0 ? void 0 : _a.updateHoverVerbosityLevel(HoverVerbosityAction.Decrease, index, args === null || args === void 0 ? void 0 : args.focus);
    }
}
