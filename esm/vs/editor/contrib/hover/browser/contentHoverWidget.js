...
let ContentHoverWidget = ContentHoverWidget_1 = class ContentHoverWidget extends ResizableContentWidget {
    get isVisibleFromKeyboard() {
        var _a;
        return (((_a = this._renderedHover) === null || _a === void 0 ? void 0 : _a.source) === 1 /* HoverStartSource.Keyboard */);
    }
    get isVisible() {
        var _a;
    ...
    dispose() {
        var _a;
        super.dispose();
        (_a = this._renderedHover) === null || _a === void 0 ? void 0 : _a.dispose();
    ...
    _findAvailableSpaceVertically() {
        var _a;
        const position = (_a = this._renderedHover) === null || _a === void 0 ? void 0 : _a.showAtPosition;
        if (!position) {
            return;
        }
    ...
    show(renderedHover) {
        ...
        const accessibleViewHint = hoverFocused && getHoverAccessibleViewHint(this._configurationService.getValue('accessibility.verbosity.hover') === true && this._accessibilityService.isScreenReaderOptimized(), (_c = (_b = this._keybindingService.lookupKeybinding('editor.action.accessibleView')) === null || _b === void 0 ? void 0 : _b.getAriaLabel()) !== null && _c !== void 0 ? _c : '');
    ...
    onContentsChanged() {
        ...
        this._updateMinimumWidth();
        this._resizableNode.layout(height, width);
        if ((_a = this._renderedHover) === null || _a === void 0 ? void 0 : _a.showAtPosition) {
            const widgetHeight = dom.getTotalHeight(this._hover.containerDomNode);
