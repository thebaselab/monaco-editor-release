...
let MarkdownHoverParticipant = class MarkdownHoverParticipant {
    ...
    getAccessibleContent(hoverPart) {
        var _a, _b;
        return (_b = (_a = this._renderedHoverParts) === null || _a === void 0 ? void 0 : _a.getAccessibleContent(hoverPart)) !== null && _b !== void 0 ? _b : '';
    }
    ...
    updateMarkdownHoverVerbosityLevel(action, index, focus) {
        var _a;
        return Promise.resolve((_a = this._renderedHoverParts) === null || _a === void 0 ? void 0 : _a.updateMarkdownHoverPartVerbosityLevel(action, index, focus));
    }
};
