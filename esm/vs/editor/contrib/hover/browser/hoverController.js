...
let HoverController = HoverController_1 = class HoverController extends Disposable {
    ...
    getAccessibleWidgetContent() {
        var _a;
        return (_a = this._contentWidget) === null || _a === void 0 ? void 0 : _a.getAccessibleWidgetContent();
    }
    getAccessibleWidgetContentAtIndex(index) {
        var _a;
        return (_a = this._contentWidget) === null || _a === void 0 ? void 0 : _a.getAccessibleWidgetContentAtIndex(index);
    }
