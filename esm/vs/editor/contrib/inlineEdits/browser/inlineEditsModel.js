...
let InlineEditsModel = InlineEditsModel_1 = class InlineEditsModel extends Disposable {
    ...
    constructor(textModel, _textModelVersionId, _selection, _debounceValue, languageFeaturesService, _diffProviderFactoryService, _modelService) {
        ...
        this.inlineEdit = derived(this, reader => {
            var _a, _b;
            return (_b = (_a = this._inlineEdit.read(reader)) === null || _a === void 0 ? void 0 : _a.promiseResult.read(reader)) === null || _b === void 0 ? void 0 : _b.data;
        });
        this._inlineEdit = derived(this, reader => {
            ...
            function removeIndentation(lines) {
                var _a, _b;
                const indentation = (_b = (_a = lines[0].match(/^\s*/)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : '';
        ...
        this._inlineEdits = derivedOpts({ owner: this, equalsFn: structuralEquals }, reader => {
            var _a, _b;
            return (_b = (_a = this._inlineEditsFetchResult.read(reader)) === null || _a === void 0 ? void 0 : _a.completions.map(c => new InlineEditData(c))) !== null && _b !== void 0 ? _b : [];
        });
        this._fetchInlineEditsPromise = derivedHandleChanges({
            ...
            const selection = (_a = this._pinnedRange.range.read(reader)) !== null && _a !== void 0 ? _a : mapValue(this._selection.read(reader), v => v.isEmpty() ? undefined : v);
            if (!selection) {
...
class TrackedRange extends Disposable {
    constructor(_textModel, _versionId) {
        ...
        this.range = derived(this, reader => {
            ...
            return (_a = this._textModel.getDecorationRange(deco)) !== null && _a !== void 0 ? _a : null;
        });
