...
let InlineEditsController = InlineEditsController_1 = class InlineEditsController extends Disposable {
    static get(editor) {
    ...
    constructor(editor, _instantiationService, _contextKeyService, _debounceService, _languageFeaturesService, _configurationService) {
        ...
        this._selection = derived(this, reader => { var _a; return (_a = this._editorObs.cursorSelection.read(reader)) !== null && _a !== void 0 ? _a : new Selection(1, 1, 1, 1); });
        ...
        this._hadInlineEdit = derivedObservableWithCache(this, (reader, lastValue) => { var _a; return lastValue || ((_a = this.model.read(reader)) === null || _a === void 0 ? void 0 : _a.inlineEdit.read(reader)) !== undefined; });
        this._widget = derivedDisposable(this, reader => {
            if (!this._hadInlineEdit.read(reader)) {
                return undefined;
            }
            return this._instantiationService.createInstance(readHotReloadableExport(InlineEditsWidget, reader), this.editor, this.model.map((m, reader) => m === null || m === void 0 ? void 0 : m.inlineEdit.read(reader)), flattenSettableObservable((reader) => { var _a, _b; return (_b = (_a = this.model.read(reader)) === null || _a === void 0 ? void 0 : _a.userPrompt) !== null && _b !== void 0 ? _b : observableValue('empty', ''); }));
        });
        this._register(bindContextKey(inlineEditVisible, this._contextKeyService, r => { var _a; return !!((_a = this.model.read(r)) === null || _a === void 0 ? void 0 : _a.inlineEdit.read(r)); }));
        this._register(bindContextKey(isPinnedContextKey, this._contextKeyService, r => { var _a; return !!((_a = this.model.read(r)) === null || _a === void 0 ? void 0 : _a.isPinned.read(r)); }));
        this.model.recomputeInitiallyAndOnChange(this._store);
        this._widget.recomputeInitiallyAndOnChange(this._store);
    }
};
InlineEditsController.ID = 'editor.contrib.inlineEditsController';
