...
ShowNextInlineEditAction.ID = showNextInlineEditActionId;
...
ShowPreviousInlineEditAction.ID = showPreviousInlineEditActionId;
...
HideInlineEdit.ID = 'editor.action.inlineEdits.hide';
