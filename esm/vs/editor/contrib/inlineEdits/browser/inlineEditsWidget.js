...
let InlineEditsWidget = class InlineEditsWidget extends Disposable {
    constructor(_editor, _edit, _userPrompt, _instantiationService) {
        ...
        this._decorations = derived(this, (reader) => {
            ...
            const diff = (_a = this._edit.read(reader)) === null || _a === void 0 ? void 0 : _a.changes;
            if (!diff) {
                return [];
            }
        ...
        this._register(observableCodeEditor(_editor).createOverlayWidget({
            ...
            minContentWidthInPx: derived(reader => {
                var _a;
                const x = (_a = this._layout1.read(reader)) === null || _a === void 0 ? void 0 : _a.left;
                if (x === undefined) {
                    return 0;
                }
        ...
        this._register(createTwoWaySync(mapSettableObservable(this._userPrompt, v => v !== null && v !== void 0 ? v : '', v => v), observableCodeEditor(this._promptEditor).value));
        this._register(autorun(reader => {
