...
export class FindWidget extends Widget {
    ...
    _updateMatchesCount() {
        ...
        (_a = this._matchesCount.firstChild) === null || _a === void 0 ? void 0 : _a.remove();
        let label;
...
export class SimpleButton extends Widget {
    constructor(opts, hoverService) {
        ...
        this._register(hoverService.setupManagedHover((_a = opts.hoverDelegate) !== null && _a !== void 0 ? _a : getDefaultHoverDelegate('element'), this._domNode, this._opts.label));
