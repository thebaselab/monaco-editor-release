...
let SuggestModel = SuggestModel_1 = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        ...
        if (this._editor.getOption(119 /* EditorOption.suggest */).snippetsPreventQuickSuggestions && ((_a = SnippetController2.get(this._editor)) === null || _a === void 0 ? void 0 : _a.isInSnippet())) {
