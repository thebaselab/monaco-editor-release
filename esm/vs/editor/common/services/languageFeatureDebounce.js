...
class FeatureDebounceInformation {
    constructor(_logService, _name, _registry, _default, _min, _max = Number.MAX_SAFE_INTEGER) {
...
let LanguageFeatureDebounceService = class LanguageFeatureDebounceService {
    ...
    for(feature, name, config) {
        ...
        const extra = (_b = config === null || config === void 0 ? void 0 : config.key) !== null && _b !== void 0 ? _b : undefined;
