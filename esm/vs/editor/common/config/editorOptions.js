...
class EditorFontSize extends SimpleEditorOption {
    constructor() {
        super(47 /* EditorOption.fontSize */, 'fontSize', EDITOR_FONT_DEFAULTS.fontSize, {
            type: 'number',
            minimum: 6,
            maximum: 100,
...
class EditorFontWeight extends BaseEditorOption {
    constructor() {
        super(48 /* EditorOption.fontWeight */, 'fontWeight', EDITOR_FONT_DEFAULTS.fontWeight, {
            anyOf: [
                {
                    type: 'number',
...
export class EditorLayoutInfoComputer extends ComputedEditorOption {
    ...
    static computeLayout(options, env) {
        ...
        const showFoldingDecoration = options.get(100 /* EditorOption.showFoldingControls */) !== 'never';
...
class EditorStickyScroll extends BaseEditorOption {
    constructor() {
        ...
        super(105 /* EditorOption.stickyScroll */, 'stickyScroll', defaults, {
...
class EditorLineHeight extends EditorFloatOption {
    constructor() {
        super(60 /* EditorOption.lineHeight */, 'lineHeight', EDITOR_FONT_DEFAULTS.lineHeight, x => EditorFloatOption.clamp(x, 0, 150), { markdownDescription: nls.localize('lineHeight', "Controls the line height. \n - Use 0 to automatically compute the line height from the font size.\n - Values between 0 and 8 will be used as a multiplier with the font size.\n - Values greater than or equal to 8 will be used as effective values.") });
    }
    compute(env, options, value) {
...
export const EditorOptions = {
    ...
    fontFamily: register(new EditorStringOption(44 /* EditorOption.fontFamily */, 'fontFamily', EDITOR_FONT_DEFAULTS.fontFamily, { description: nls.localize('fontFamily', "Controls the font family.") })),
    ...
    letterSpacing: register(new EditorFloatOption(57 /* EditorOption.letterSpacing */, 'letterSpacing', EDITOR_FONT_DEFAULTS.letterSpacing, x => EditorFloatOption.clamp(x, -5, 20), { description: nls.localize('letterSpacing', "Controls the letter spacing in pixels.") })),
    ...
    revealHorizontalRightPadding: register(new EditorIntOption(90 /* EditorOption.revealHorizontalRightPadding */, 'revealHorizontalRightPadding', 15, 0, 1000)),
    ...
    scrollBeyondLastColumn: register(new EditorIntOption(94 /* EditorOption.scrollBeyondLastColumn */, 'scrollBeyondLastColumn', 4, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { description: nls.localize('scrollBeyondLastColumn', "Controls the number of extra characters beyond which the editor will scroll horizontally.") })),
    ...
    showFoldingControls: register(new EditorStringEnumOption(100 /* EditorOption.showFoldingControls */, 'showFoldingControls', 'mouseover', ['always', 'never', 'mouseover'], {
        enumDescriptions: [
