...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    constructor(action, _options, _keybindingService, _notificationService, _contextKeyService, _themeService, _contextMenuService, _accessibilityService) {
        super(undefined, action, { icon: !!(action.class || action.item.icon), label: !action.class && !action.item.icon, draggable: _options === null || _options === void 0 ? void 0 : _options.draggable, keybinding: _options === null || _options === void 0 ? void 0 : _options.keybinding, hoverDelegate: _options === null || _options === void 0 ? void 0 : _options.hoverDelegate });
...
export class TextOnlyMenuEntryActionViewItem extends MenuEntryActionViewItem {
    render(container) {
        ...
        container.classList.toggle('use-comma', (_b = (_a = this._options) === null || _a === void 0 ? void 0 : _a.useComma) !== null && _b !== void 0 ? _b : false);
    }
    updateLabel() {
        var _a;
        ...
        if (this.label) {
            ...
            if ((_a = this._options) === null || _a === void 0 ? void 0 : _a.conversational) {
    ...
    static _symbolPrintEnter(kb) {
        var _a;
        return (_a = kb.getLabel()) === null || _a === void 0 ? void 0 : _a.replace(/\benter\b/gi, '\u23CE').replace(/\bEscape\b/gi, 'Esc');
    }
}
