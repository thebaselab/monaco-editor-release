        ...
        for (const { overrides, source } of configurationDefaults) {
            for (const key in overrides) {
                ...
                if (OVERRIDE_PROPERTY_REGEX.test(key)) {
                    ...
                    const defaultValue = (configurationDefaultOverride === null || configurationDefaultOverride === void 0 ? void 0 : configurationDefaultOverride.value) || {};
                    for (const configuration of Object.keys(overrides[key])) {
                        ...
                        if (isObjectSetting) {
                            ...
                            defaultValue[configuration] = { ...((_b = defaultValue[configuration]) !== null && _b !== void 0 ? _b : {}), ...overrideValue };
                    ...
                    let existingDefaultValue = (_c = existingDefaultOverride === null || existingDefaultOverride === void 0 ? void 0 : existingDefaultOverride.value) !== null && _c !== void 0 ? _c : property === null || property === void 0 ? void 0 : property.defaultDefaultValue;
                    let newDefaultValue = overrides[key];
                    let newDefaultValueSource = source;
                    const isObjectSetting = types.isObject(newDefaultValue) && (property !== undefined && property.type === 'object' ||
                    ...
                    if (isObjectSetting) {
                        ...
                        newDefaultValueSource = (_d = existingDefaultOverride === null || existingDefaultOverride === void 0 ? void 0 : existingDefaultOverride.source) !== null && _d !== void 0 ? _d : new Map();
