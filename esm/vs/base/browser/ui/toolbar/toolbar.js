...
export class ToolBar extends Disposable {
    ...
    setActions(primaryActions, secondaryActions) {
        ...
        primaryActionsToSet.forEach(action => {
            var _a, _b;
            this.actionBar.push(action, { icon: (_a = this.options.icon) !== null && _a !== void 0 ? _a : true, label: (_b = this.options.label) !== null && _b !== void 0 ? _b : false, keybinding: this.getKeybindingLabel(action) });
        });
    }
    getKeybindingLabel(action) {
        var _a, _b, _c;
        const key = (_b = (_a = this.options).getKeyBinding) === null || _b === void 0 ? void 0 : _b.call(_a, action);
