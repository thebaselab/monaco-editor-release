...
export class Button extends Disposable {
    ...
    setTitle(title) {
        ...
        if (!this._hover && title !== '') {
            this._hover = this._register(getBaseLayerHoverDelegate().setupManagedHover((_a = this.options.hoverDelegate) !== null && _a !== void 0 ? _a : getDefaultHoverDelegate('mouse'), this._element, title));
        }
        else if (this._hover) {
