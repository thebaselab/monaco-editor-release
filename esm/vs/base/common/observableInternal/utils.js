...
export function observableFromEventOpts(options, event, getValue) {
    var _a, _b;
    return new FromEventObservable(new DebugNameData(options.owner, options.debugName, (_a = options.debugReferenceFn) !== null && _a !== void 0 ? _a : getValue), event, getValue, () => FromEventObservable.globalTransaction, (_b = options.equalsFn) !== null && _b !== void 0 ? _b : strictEquals);
}
