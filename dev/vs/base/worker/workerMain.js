    ...
    if (typeof nodeProcess === 'object') {
        ...
        if (rawNlsConfig) {
            try {
                ...
                _translationsConfigFile = (_c = nlsConfig.languagePack) === null || _c === void 0 ? void 0 : _c.translationsConfigFile;
            }
            catch (e) {
            }
        }
...
define(__m[10/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/,19/*vs/base/common/functional*/,13/*vs/base/common/lifecycle*/,21/*vs/base/common/linkedList*/,23/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        get event() {
            ...
            (_a = this._event) !== null && _a !== void 0 ? _a : (this._event = (callback, thisArgs, disposables) => {
                ...
                if (_listenerFinalizers) {
                    ...
                    _listenerFinalizers.register(result, (_h = match === null || match === void 0 ? void 0 : match[2]) !== null && _h !== void 0 ? _h : stack, result);
                }
                return result;
            });
            return this._event;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[70/*vs/base/common/worker/simpleWorker*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/,10/*vs/base/common/event*/,13/*vs/base/common/lifecycle*/,15/*vs/base/common/objects*/,14/*vs/base/common/platform*/,6/*vs/base/common/strings*/]), function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[45/*vs/editor/common/core/selection*/], __M([0/*require*/,1/*exports*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/]), function (require, exports, position_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[29/*vs/editor/common/core/textLength*/], __M([0/*require*/,1/*exports*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/]), function (require, exports, position_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[46/*vs/editor/common/core/positionToOffset*/], __M([0/*require*/,1/*exports*/,3/*vs/editor/common/core/offsetRange*/,29/*vs/editor/common/core/textLength*/]), function (require, exports, offsetRange_1, textLength_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[47/*vs/editor/common/core/textEdit*/], __M([0/*require*/,1/*exports*/,9/*vs/base/common/assert*/,5/*vs/base/common/errors*/,4/*vs/editor/common/core/position*/,46/*vs/editor/common/core/positionToOffset*/,2/*vs/editor/common/core/range*/,29/*vs/editor/common/core/textLength*/]), function (require, exports, assert_1, errors_1, position_1, positionToOffset_1, range_1, textLength_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[49/*vs/editor/common/diff/defaultLinesDiffComputer/heuristicSequenceOptimizations*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/arrays*/,3/*vs/editor/common/core/offsetRange*/,8/*vs/editor/common/diff/defaultLinesDiffComputer/algorithms/diffAlgorithm*/]), function (require, exports, arrays_1, offsetRange_1, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[51/*vs/editor/common/diff/defaultLinesDiffComputer/algorithms/dynamicProgrammingDiffing*/], __M([0/*require*/,1/*exports*/,3/*vs/editor/common/core/offsetRange*/,8/*vs/editor/common/diff/defaultLinesDiffComputer/algorithms/diffAlgorithm*/,17/*vs/editor/common/diff/defaultLinesDiffComputer/utils*/]), function (require, exports, offsetRange_1, diffAlgorithm_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[32/*vs/editor/common/diff/defaultLinesDiffComputer/linesSliceCharSequence*/], __M([0/*require*/,1/*exports*/,12/*vs/base/common/arraysFind*/,3/*vs/editor/common/core/offsetRange*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,17/*vs/editor/common/diff/defaultLinesDiffComputer/utils*/]), function (require, exports, arraysFind_1, offsetRange_1, position_1, range_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[18/*vs/editor/common/diff/rangeMapping*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/errors*/,11/*vs/editor/common/core/lineRange*/,2/*vs/editor/common/core/range*/,47/*vs/editor/common/core/textEdit*/]), function (require, exports, errors_1, lineRange_1, range_1, textEdit_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[52/*vs/editor/common/diff/defaultLinesDiffComputer/computeMovedLines*/], __M([0/*require*/,1/*exports*/,8/*vs/editor/common/diff/defaultLinesDiffComputer/algorithms/diffAlgorithm*/,18/*vs/editor/common/diff/rangeMapping*/,7/*vs/base/common/arrays*/,12/*vs/base/common/arraysFind*/,22/*vs/base/common/map*/,11/*vs/editor/common/core/lineRange*/,3/*vs/editor/common/core/offsetRange*/,32/*vs/editor/common/diff/defaultLinesDiffComputer/linesSliceCharSequence*/,17/*vs/editor/common/diff/defaultLinesDiffComputer/utils*/,31/*vs/editor/common/diff/defaultLinesDiffComputer/algorithms/myersDiffAlgorithm*/]), function (require, exports, diffAlgorithm_1, rangeMapping_1, arrays_1, arraysFind_1, map_1, lineRange_1, offsetRange_1, linesSliceCharSequence_1, utils_1, myersDiffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[61/*vs/editor/common/model/mirrorTextModel*/], __M([0/*require*/,1/*exports*/,6/*vs/base/common/strings*/,4/*vs/editor/common/core/position*/,60/*vs/editor/common/model/prefixSumComputer*/]), function (require, exports, strings_1, position_1, prefixSumComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[67/*vs/nls*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    ...
    function lookupMessage(index, fallback) {
        var _a;
        // VSCODE_GLOBALS: NLS
        const message = (_a = globalThis._VSCODE_NLS_MESSAGES) === null || _a === void 0 ? void 0 : _a[index];
...
define(__m[68/*vs/editor/common/languages*/], __M([0/*require*/,1/*exports*/,44/*vs/base/common/codicons*/,16/*vs/base/common/uri*/,2/*vs/editor/common/core/range*/,66/*vs/editor/common/tokenizationRegistry*/,67/*vs/nls*/]), function (require, exports, codicons_1, uri_1, range_1, tokenizationRegistry_1, nls_1) {
    ...
    exports.symbolKindNames = {
        [17 /* SymbolKind.Array */]: (0, nls_1.localize)(1753, "array"),
        [16 /* SymbolKind.Boolean */]: (0, nls_1.localize)(1754, "boolean"),
        [4 /* SymbolKind.Class */]: (0, nls_1.localize)(1755, "class"),
        [13 /* SymbolKind.Constant */]: (0, nls_1.localize)(1756, "constant"),
        [8 /* SymbolKind.Constructor */]: (0, nls_1.localize)(1757, "constructor"),
        [9 /* SymbolKind.Enum */]: (0, nls_1.localize)(1758, "enumeration"),
        [21 /* SymbolKind.EnumMember */]: (0, nls_1.localize)(1759, "enumeration member"),
        [23 /* SymbolKind.Event */]: (0, nls_1.localize)(1760, "event"),
        [7 /* SymbolKind.Field */]: (0, nls_1.localize)(1761, "field"),
        [0 /* SymbolKind.File */]: (0, nls_1.localize)(1762, "file"),
        [11 /* SymbolKind.Function */]: (0, nls_1.localize)(1763, "function"),
        [10 /* SymbolKind.Interface */]: (0, nls_1.localize)(1764, "interface"),
        [19 /* SymbolKind.Key */]: (0, nls_1.localize)(1765, "key"),
        [5 /* SymbolKind.Method */]: (0, nls_1.localize)(1766, "method"),
        [1 /* SymbolKind.Module */]: (0, nls_1.localize)(1767, "module"),
        [2 /* SymbolKind.Namespace */]: (0, nls_1.localize)(1768, "namespace"),
        [20 /* SymbolKind.Null */]: (0, nls_1.localize)(1769, "null"),
        [15 /* SymbolKind.Number */]: (0, nls_1.localize)(1770, "number"),
        [18 /* SymbolKind.Object */]: (0, nls_1.localize)(1771, "object"),
        [24 /* SymbolKind.Operator */]: (0, nls_1.localize)(1772, "operator"),
        [3 /* SymbolKind.Package */]: (0, nls_1.localize)(1773, "package"),
        [6 /* SymbolKind.Property */]: (0, nls_1.localize)(1774, "property"),
        [14 /* SymbolKind.String */]: (0, nls_1.localize)(1775, "string"),
        [22 /* SymbolKind.Struct */]: (0, nls_1.localize)(1776, "struct"),
        [25 /* SymbolKind.TypeParameter */]: (0, nls_1.localize)(1777, "type parameter"),
        [12 /* SymbolKind.Variable */]: (0, nls_1.localize)(1778, "variable"),
    };
    /**
     * @internal
     */
    function getAriaLabelForSymbol(symbolName, kind) {
        return (0, nls_1.localize)(1779, '{0} ({1})', symbolName, exports.symbolKindNames[kind]);
    }
    /**
     * @internal
     */
